import{g as H,i as je,h as ee,a as P,j as Be,r as $e,s as ze,k as D,e as le,m as te,o as G,p as Ie,q as Ve,l as X,t as Se,f as Z,C as Ue,u as Fe,v as O,w as qe,P as Ee,d as R,x as Pe,y as we,z as Ne,B as Re,D as Oe,T as Ke,E as De,F as Ge}from"./data-BJ1vRtvR.js";import{k as We,a as Je,r as Qe,f as Ye,p as Xe,e as Ze,s as et,b as tt,m as nt,n as at,l as st,d as oe,o as ne}from"./engine-CG3I_ha3.js";import{r as ae,f as it}from"./ai-C4jWyOom.js";import{$ as ce}from"./vendor-DvnuzqsD.js";import{l as rt,g as W,a as lt,b as ot,i as ct,h as de,s as dt,c as ut,m as xe,d as pt,r as mt,e as yt,u as ht,f as bt,j as ue,C as Le}from"./persist-ZhkrWjrH.js";const ft={tutorial_01:[{title:"座位與體力",body:"周圍是各座位。紅心是體力。你永遠在畫面靠近自己的一側。點座位上的 ℹ 可看武將技能。"},{title:"手牌區",body:"底部一排是你的手牌。亮起、可點的牌才是現在能用的。點 ℹ 看牌面說明。"},{title:"出【殺】",body:"出牌階段點一張【殺】（再點一次打出），然後點亮起的敵方座位作為目標。對方可出【閃】抵消。"},{title:"結束與棄牌",body:"不想再出牌就按「結束出牌」。手牌多過體力上限時，要棄到上限。完成後輪到對手。"}],tutorial_02:[{title:"裝備區",body:"座位上「裝備」那一行就是裝備區。本關你已戴上【諸葛連弩】：攻擊範圍 1，但一回合可出多張【殺】。"},{title:"錦囊",body:"【無中生有】摸兩張；【過河拆橋】選一名角色，棄其手牌或裝備（手牌背面看不見內容）。錦囊多數無距離限制。"},{title:"再出殺",body:"有連弩時，出完一張【殺】後仍可再出【殺】。打完按「結束出牌」。"}],tutorial_03:[{title:"瀕死",body:"體力到 0 會問全場是否出【桃】。救到體力大於 0 才活。問到你時，亮起的【桃】點兩下打出。"},{title:"這一關",body:"雙方體力都很低。你可用【殺】先手；自己受傷時記得留【桃】。華佗的紅牌也可當桃（技能詳見 ℹ）。"}]};function Ce(e){return e?ft[e]??[]:[]}function _e(e){return!!e&&je(e.config.campaignStageId)}function gt(e,a){const n=e.prompt,s=e.players.find(i=>i.isHuman);if(!s||e.winnerIds)return"";if(e.matchPhase==="pick_general")return"請點選一名武將，確認後開局";if(n.actorId!==s.id)return"等待其他角色行動…";switch(n.kind){case"choose_card":{if(a){const i=s.hand.find(l=>l.uid===a);return`已選【${i?H(i.defId).name:"此牌"}】— 再點同一張打出，或點其他牌改選`}return e.phase==="play"?"出牌階段：點亮起的手牌使用，或按「結束出牌」":n.message||"請選擇一張牌"}case"choose_target":return"請點亮起、會閃爍的座位作為目標";case"respond_shan":return"需要【閃】：點亮起的【閃】打出，或按「放棄」承受傷害";case"respond_sha":return"需要【殺】：點亮起的【殺】打出，或按「放棄」";case"discard":return`棄牌階段：點選要棄的牌（需棄 ${n.discardCount??""} 張）`;case"choice":return n.message||"請在上方選項中點選";case"skill_cards":return n.message||"請依技能選擇牌，再按確認";default:return n.message||""}}function vt(e){return Array.from({length:e},(a,n)=>({id:n,type:"empty",name:"",ready:!1}))}function kt(e){return e.find(a=>a.type==="empty")}function K(){return{room:null,localName:"",joinCode:"",error:null,isHost:!1,myClientId:null}}function $t(e,a,n,s){const i=vt(n);return i[0]={id:0,type:"human",name:a,clientId:e,ready:!0},{roomId:It(),hostClientId:e,maxPlayers:n,status:"lobby",seats:i}}function It(e=4){const a="ABCDEFGHJKLMNPQRSTUVWXYZ23456789";let n="";for(let s=0;s<e;s++)n+=a[Math.floor(Math.random()*a.length)];return n}function St(e){const a=e.seats.map(n=>n.type==="empty"?{...n,type:"ai",name:`電腦${n.id+1}`,ready:!0}:n);return{...e,seats:a}}function He(e){return e.filter(a=>a.type==="human").length}function qt(e,a){return a&&e.status==="lobby"&&He(e.seats)>=1}function Et(e){const{room:a,localName:n,joinCode:s,error:i,isHost:r}=e;if(!a)return`
  ...
  <div class="screen start-screen">
    ...
    ${Tt()}
  </div>`}function he(){xe(),t.storyKind="campaign",t.campaignId=Ke,t.screen="story",m()}function Bt(){var e,a;(e=u().querySelector("#tut-yes"))==null||e.addEventListener("click",()=>he()),(a=u().querySelector("#tut-later"))==null||a.addEventListener("click",()=>{xe(),m()}),u().querySelectorAll("[data-go]").forEach(n=>{n.addEventListener("click",()=>{const s=n.dataset.go;if(s==="tutorial"){he();return}s==="story"&&(t.storyKind="campaign",t.campaignId=null),s==="liezhuan"&&(t.storyKind="liezhuan",t.campaignId=null),t.screen=s,m()})})}function zt(e){var n,s,i;const a=t.mpClient;if(a)if(e.type==="room"){t.lobbyVm.room=e.room,t.lobbyVm.isHost=e.room.hostClientId===a.clientId,t.lobbyVm.error=null;const r=e.room.seats.find(l=>l.clientId===a.clientId);t.localSeatId=r?r.id:t.localSeatId,e.room.status==="playing"&&e.room.match&&(t.game=e.room.match,t.screen="table"),m()}else if(e.type==="match")t.game=e.match,t.selectedUid=null,t.fxSettledSeq=null,t.matchEndPending=!1,t.matchPaused=!1,t.aiBusy=!1,t.stage=null,t.screen="table",m(),t.lobbyVm.isHost&&t.game&&ae(t.game,()=>{t.screen==="table"&&m()});else if(e.type==="remote_action"){if(!t.lobbyVm.isHost||!t.game)return;const r=(n=t.lobbyVm.room)==null?void 0:n.seats.find(g=>g.clientId===e.clientId);if(!r||r.type!=="human")return;const l=Ht(e.action);if(!l)return;const o=t.game,d=o.prompt.actorId;if(o.matchPhase!=="pick_general"&&d!==null&&d!==r.id)return;Me(o,r.id,l),(s=t.mpClient)==null||s.send({type:"host_match",match:o}),L()}else e.type==="error"&&(t.lobbyVm.error=e.message,(e.message.includes("離開")||e.message.includes("關閉"))&&((i=t.mpClient)==null||i.disconnect(),t.mpClient=null,t.lobbyVm=K(),t.localSeatId=null,t.screen="start"),m())}function be(){return t.mpClient||(t.mpClient=xt(),t.mpClient.onMessage(zt)),t.mpClient}function Vt(){var n,s,i;if(!t.lobbyVm.room||!t.lobbyVm.isHost)return;const e=St(t.lobbyVm.room),a=e.maxPlayers>=8?"identity8":"identity5";try{const r=Oe({mode:a,packs:t.settings.enabledPacks,forceSelectGeneral:t.settings.forceSelectGeneral,seats:e.seats.map(d=>({name:d.name,isHuman:d.type==="human"}))}),l=ne(r),o={...e,status:"playing",match:l};t.lobbyVm.room=o,t.game=l,t.localSeatId=((n=e.seats.find(d=>{var g;return d.clientId===((g=t.mpClient)==null?void 0:g.clientId)}))==null?void 0:n.id)??0,t.selectedUid=null,t.fxSettledSeq=null,t.matchEndPending=!1,t.matchPaused=!1,t.stage=null,(s=t.mpClient)==null||s.send({type:"host_room",room:o}),(i=t.mpClient)==null||i.send({type:"host_match",match:l}),t.screen="table",m(),ae(l,()=>{var d;t.screen==="table"&&m(),t.lobbyVm.isHost&&t.game&&((d=t.mpClient)==null||d.send({type:"host_match",match:t.game}))})}catch(r){t.lobbyVm.error=r instanceof Error?r.message:"開局失敗",m()}}function Ut(){var i,r,l,o,d,g,b;const e=t.lobbyVm;(i=u().querySelector('[data-go="start"]'))==null||i.addEventListener("click",()=>{var y;(y=t.mpClient)==null||y.disconnect(),t.mpClient=null,t.lobbyVm=K(),t.localSeatId=null,t.screen="start",m()});const a=u().querySelector("#lobby-name"),n=u().querySelector("#lobby-code"),s=y=>{const h=(a==null?void 0:a.value.trim())||"房主",c=be(),$=$t(c.clientId,h,y);t.lobbyVm={...e,localName:h,room:null,isHost:!0,myClientId:c.clientId,error:c.isOnline?"正在建立房間（連線 PeerJS）…":"本地預覽模式（VITE_MP_OFFLINE=1）"},t.localSeatId=0,m(),c.connect($.roomId),c.send({type:"host_room",room:$})};(r=u().querySelector("#lobby-create-5"))==null||r.addEventListener("click",()=>s(5)),(l=u().querySelector("#lobby-create-8"))==null||l.addEventListener("click",()=>s(8)),(o=u().querySelector("#lobby-join"))==null||o.addEventListener("click",()=>{const y=(a==null?void 0:a.value.trim())||"玩家",h=((n==null?void 0:n.value)||"").trim().toUpperCase();if(!h){t.lobbyVm.error="請輸入房號",m();return}const c=be();t.lobbyVm={...e,localName:y,joinCode:h,isHost:!1,myClientId:c.clientId,error:c.isOnline?`正在加入房間 ${h}…`:"本地預覽模式無法真正加入其他房間"},m(),c.connect(h).then(()=>{c.send({type:"join",name:y})})}),(d=u().querySelector("#lobby-copy"))==null||d.addEventListener("click",()=>{var h,c;const y=(h=t.lobbyVm.room)==null?void 0:h.roomId;y&&((c=navigator.clipboard)==null||c.writeText(y))}),(g=u().querySelector("#lobby-leave"))==null||g.addEventListener("click",()=>{var y,h;(y=t.mpClient)==null||y.send({type:"leave"}),(h=t.mpClient)==null||h.disconnect(),t.mpClient=null,t.lobbyVm=K(),t.localSeatId=null,t.screen="start",m()}),(b=u().querySelector("#lobby-start"))==null||b.addEventListener("click",()=>{Vt()})}function Ft(e){var r,l,o;const a=e.setup;if(!a)return"";const n=[],s=a.player;(r=s==null?void 0:s.equipKinds)!=null&&r.length&&n.push(`你裝備：${s.equipKinds.join("、")}`),(l=s==null?void 0:s.handKinds)!=null&&l.length&&n.push(`你指定手牌：${s.handKinds.join("、")}`),(s==null?void 0:s.handCount)!=null&&n.push(`你手牌數 ${s.handCount}`),((s==null?void 0:s.hp)!=null||(s==null?void 0:s.maxHp)!=null)&&n.push(`你體力 ${s.hp??s.maxHp}/${s.maxHp??s.hp}`);const i=a.enemies;return((i==null?void 0:i.hp)!=null||(i==null?void 0:i.maxHp)!=null)&&n.push(`敵體力 ${i.hp??i.maxHp}/${i.maxHp??i.hp}`),(o=i==null?void 0:i.equipKinds)!=null&&o.length&&n.push(`敵裝備：${i.equipKinds.join("、")}`),n.length?`<p class="intel-pack">特殊開局：${n.map(f).join("　·　")}</p>`:""}function Nt(e){if(!_e(e)||t.coachSlide<0||e.winnerIds)return"";const a=Ce(e.config.campaignStageId);if(!a.length||t.coachSlide>=a.length)return"";const n=a[t.coachSlide],s=a.length,i=t.coachSlide>=s-1;return`<div class="coach-layer" role="dialog" aria-modal="true">
    <div class="coach-box">
  ...
  </div>`}function fe(e){return{wei:"魏",shu:"蜀",wu:"吳",qun:"群",god:"神"}[e]??e}function Rt(){const e=X().filter(i=>t.liezhuanFilter==="all"?!0:i.kingdom===t.liezhuanFilter),a=["all","wei","shu","wu","qun"],n=X().filter(i=>de(i.id)).length,s=X().length;return`
  <div class="screen panel-screen liezhuan-screen">
    ...
    <ul class="lz-grid">
      ${e.map(i=>{const r=Se(i.id);if(!r)return"";const l=Z(r.id),o=Math.min(l-1,r.stages.length),d=de(i.id),g=W(i.id)==="chibi",b=d?ee(i):Ot(i);return`<li class="lz-card ${d?"done":""}">
  ...
  <div class="screen panel-screen ach-screen">
    ...
    ${[{kind:"feat",title:"功業"},{kind:"campaign",title:"劇情傳記"},{kind:"set",title:"勢力集齊"},{kind:"liezhuan",title:"武將列傳"}].map(i=>{const r=e.filter(l=>l.kind===i.kind);return`<section class="ach-group">
          <h3>${i.title}</h3>
          <ul class="ach-list">
            ${r.map(l=>{const o=ct(l.id),d=l.generalId?P(l.generalId):null,g=d?`<img src="${o?ee(d):D(d)}" alt="" />`:"";return`<li class="ach-item ${o?"on":""}">
                  ${g}
                  <div>
                    <strong>${f(l.title)}</strong>
                    <span>${f(l.hint)}</span>
                  </div>
                  <em>${o?"已達成":"未達成"}</em>
                </li>`}).join("")}
  ...
  <div class="screen panel-screen">
    ...
    <ul class="stage-list campaign-pick">
      ${Ue.map(n=>{const s=Z(n.id),i=Math.min(s-1,n.stages.length);return`<li>
  ...
  <div class="screen panel-screen">
    ...
    <section class="intel-block">
      <h4>關卡設定</h4>
      <p class="intel-pack">卡包：${Ie(Ve(e))}${(g=e.requiredCardKinds)!=null&&g.length?`　·　必備：${e.requiredCardKinds.map(b=>b==="tiesuo"?"鐵索連環":b).join("、")}`:""}</p>
  ...
  <div class="screen table-screen ${i?"match-ended":""} ${t.matchPaused?"match-paused":""} ${_e(e)?"tutorial-match":""}">
    <header class="battle-top">
      <div>
        ...
        <span class="phase">${s?"請選擇武將":yn(e.phase)}</span>
      </div>
    ...
    <div class="arena" style="--n:${l}" id="arena">
      ${e.players.map(c=>{var I;const $=!!c.generalId,w=$?P(c.generalId):null,T=!s&&e.currentPlayer===c.id,C=!s&&n.kind==="choose_target"&&((I=n.targetIds)==null?void 0:I.includes(c.id))&&r,A=(c.id-a.id+l)%l,j=A/l*360+90,J=c.id===a.id?"—":String(nt(e,a.id,c.id)),Q=!s&&c.id!==a.id&&c.alive&&$&&at(e,a.id,c.id)?"in-range":"",F=Ae(c,a,e.config.mode),p=e.fx.damages.find(x=>x.playerId===c.id),v=ze(c.id),k=t.settings.showPortraits&&w?`<img class="portrait ${W(w.id)==="chibi"?"chibi-on":""}" src="${D(w)}" alt="" width="48" height="48" />`:t.settings.showPortraits?'<div class="portrait portrait-empty" aria-hidden="true">？</div>':"",E=$?`<button type="button" class="info-btn" data-info-seat="${c.id}" title="詳情" aria-label="詳情">ℹ</button>`:"";return`<div class="seat-wrap" style="--angle:${j}deg;--seat-c:${v}" data-visual="${A}" data-seat-pos="${c.id}">
            <div class="seat ${c.alive?"":"dead"} ${T?"active":""} ${c.id===a.id?"human":c.isHuman?"human-remote":""} ${C?"targetable":""} ${Q} ${s&&!$?"hidden-gen":""} ${p?"hurt":""}" data-seat="${c.id}" role="${C?"button":"group"}" tabindex="${C?"0":"-1"}">
              ${k}
              <div class="seat-head">
                <span class="seat-gen">${w?f(w.name):"未亮將"}</span>
                ${E}
              </div>
              <div class="seat-name">${f(c.name)}${F?`・${F}`:""}</div>
              <div class="hp">${$?pn(c.hp,c.maxHp):"—"}</div>
              <div class="equip">${$?mn(c):s?"等待選將":"無裝備"}</div>
              <div class="meta-row"><span>手牌 ${s?"—":c.hand.length}</span><span class="dist">距 ${J}</span></div>
              ${p?`<span class="dmg-float" data-dmg-seq="${p.seq}">-${p.amount}</span>`:""}
            </div>
          </div>`}).join("")}
      ${dn(e,a.id,l)}
    </div>
    ${b?`<div class="action-hint ${h?"loud":""}" role="status">${f(b)}</div>`:""}
    <div class="prompt-bar ${h?"prompt-loud":""}">${le(y,g)}</div>
    ${Nt(e)}
    ${s?on(e):""}
    ${!s&&r&&(n.kind==="choice"||n.kind==="skill_cards")?ln(e):""}
    ${!s&&r&&n.kind==="choose_card"?`<div class="skill-row">${st(e,a.id).map(c=>`<button type="button" class="btn ghost" data-skill="${c.id}" title="${f(c.hint)}">${f(c.label)}</button>`).join("")}</div>`:""}
    ${s?"":`<div class="hand">
      ${a.hand.map(c=>{var A,j;const $=H(c.defId),w=r&&!!((A=n.cardUids)!=null&&A.includes(c.uid))&&(n.kind==="choose_card"||n.kind==="discard"||n.kind==="respond_shan"||n.kind==="respond_sha"||n.kind==="skill_cards"),T=t.selectedUid===c.uid||n.kind==="skill_cards"&&!!((j=n.selectedCardUids)!=null&&j.includes(c.uid)),C=$.suit==="heart"||$.suit==="diamond";return`<div class="card-wrap">
            <button type="button" class="card ${w?"selectable":""} ${T?"selected":""} ${C?"red":"black"}" data-uid="${c.uid}" ${w?"":"disabled"}>
              <span class="csuit ${C?"red":""}">${te($.suit)}${G($.rank)}</span>
    ...
    <div class="choice-row">
      ${a.map(o=>{var y;const d=(n||s)&&o.id==="confirm"&&i<r,g=s&&!!((y=e.prompt.selectedCardUids)!=null&&y.includes(o.id));return`<button type="button" class="${["btn",o.id==="skip"||o.id==="no"?"ghost":"primary",g?"selected-pick":""].filter(Boolean).join(" ")}" data-choice="${o.id}" ${d?"disabled":""}>${f(o.label)}</button>`}).join("")}
    </div>
  </div>`}function on(e){const a=e.prompt.generalIds??[];return`<div class="pick-panel">
    <h3>${a.length>3?"選擇武將（全部可選）":"系統隨機三將，請選一"}</h3>
    <div class="pick-grid">
      ${a.map(s=>{const i=P(s);return`<div class="pick-card">
            ${t.settings.showPortraits?`<img class="pick-portrait ${W(i.id)==="chibi"?"chibi-on":""}" src="${D(i)}" alt="" />`:""}
            <div class="pick-name">${i.name}</div>
            <div class="pick-meta">${re(i.kingdom)}・${i.maxHp} 血</div>
  ...
  </div>`}function ge(e,a,n){const r=((e-a+n)%n/n*360+90)*Math.PI/180,l=38;return{x:50+Math.cos(r)*l,y:50+Math.sin(r)*l}}function cn(e,a){var n;if(e.fx.play)return e.fx.play;if(e.prompt.kind==="choose_target"&&((n=e.prompt.cardUids)!=null&&n[0])&&e.prompt.actorId!==null){const s=e.players[e.prompt.actorId],i=s==null?void 0:s.hand.find(r=>r.uid===e.prompt.cardUids[0]);if(i){const r=H(i.defId);return{cardName:r.name,suit:r.suit,rank:r.rank,sourceId:e.prompt.actorId,targetIds:[],note:"選擇目標",seq:0}}}return null}function dn(e,a,n){const s=cn(e);if(!s&&!e.fx.damages.length)return'<div class="arena-center" aria-hidden="true"><span>距離</span></div>';const i=!!(s&&t.fxSettledSeq===s.seq),r=s?ge(s.sourceId,a,n):null,l=s&&r?s.targetIds.filter(b=>b!==s.sourceId).map(b=>{const y=ge(b,a,n);return un(r.x,r.y,y.x,y.y,s.seq,i)}).join(""):"",o=s&&s.targetIds.length===1&&s.targetIds[0]===s.sourceId?`<div class="fx-self-ring ${i?"fx-settled":""}" style="left:${r.x}%;top:${r.y}%"></div>`:"",d=s&&(s.suit==="heart"||s.suit==="diamond"),g=s?`<div class="fx-card ${d?"red":"black"} ${i?"fx-settled":""}" data-fx-seq="${s.seq}">
        <span class="csuit">${te(s.suit)}${G(s.rank)}</span>
    ...
    </div>`}function un(e,a,n,s,i,r=!1){const l=n-e,o=s-a,d=Math.hypot(l,o)||1,g=Math.min(8,d*.2),b=e+l/d*g,y=a+o/d*g,h=n-l/d*g,c=s-o/d*g;return`<line class="fx-arrow-line ${r?"fx-settled":""}" data-fx-seq="${i}" x1="${b}" y1="${y}" x2="${h}" y2="${c}" marker-end="url(#arrowHead)" />`}function pn(e,a){const n=Math.max(0,e);return"●".repeat(n)+"○".repeat(Math.max(0,a-n))}function mn(e){const a=[];if(e.equips.weapon){const n=H(e.equips.weapon.defId),s=n.attackRange??1;a.push(`<span class="eq-line eq-weapon">${f(n.name)} <em>攻${s}</em></span>`)}if(e.equips.armor){const n=H(e.equips.armor.defId);a.push(`<span class="eq-line eq-armor">${f(n.name)}</span>`)}if(e.equips.horseMinus){const n=H(e.equips.horseMinus.defId);a.push(`<span class="eq-line eq-horse">-1 ${f(n.name)}</span>`)}if(e.equips.horsePlus){const n=H(e.equips.horsePlus.defId);a.push(`<span class="eq-line eq-horse">+1 ${f(n.name)}</span>`)}for(const n of e.judges??[]){const s=H(n.defId);a.push(`<span class="eq-line eq-judge">判定・${f(s.name)}</span>`)}return a.length?a.join(""):"無裝備"}function yn(e){return{prepare:"準備",judge:"判定",draw:"摸牌",play:"出牌",discard:"棄牌",end:"結束"}[e]??e}function hn(e){return{basic:"基本",trick:"錦囊",equip:"裝備"}[e]??e}function Te(e){return e.slot==="weapon"?`武器・攻${e.attackRange??1}`:e.slot==="armor"?"防具":e.slot==="horseMinus"?"-1坐騎":e.slot==="horsePlus"?"+1坐騎":hn(e.type)}function bn(e){if(!e.generalId)return`<h3>${R(e.name,e.id)}</h3><p class="muted">尚未亮出武將。</p>`;const a=P(e.generalId),n=["weapon","armor","horseMinus","horsePlus"].map(l=>{const o=e.equips[l];if(!o)return null;const d=H(o.defId);let g="";return l==="weapon"?g=`攻擊範圍 ${d.attackRange??1}`:l==="horseMinus"?g="-1 坐騎（與其他角色距離-1）":l==="horsePlus"?g="+1 坐騎（其他角色與你距離+1）":l==="armor"&&(g="防具"),`<li><strong>${f(d.name)}</strong>（${we(d.suit)}${G(d.rank)}）· ${g}<br/><span class="muted">${Pe[d.kind]??""}</span></li>`}).filter(Boolean).join(""),s=t.game;let i="";s&&(s.config.mode==="identity5"||s.config.mode==="identity8")&&(i=it(s,e.id),t.settings.showAiDebug||(i=i.replace(/<p class="mind-thought">[\s\S]*?<\/p>/,"")));const r=s&&(()=>{const l=s.players.find(d=>d.isHuman);if(!l)return"";const o=Ae(e,l,s.config.mode);return o?`<p class="muted">公開身份資訊：${o}</p>`:""})();return`<h3>${R(a.name,e.id)} <span class="muted">·</span> ${R(e.name,e.id)}</h3>
    ...
    <h4>武將技</h4>
    <p>${f(a.skillText)}</p>`}function gn(e,a){const n=a.hand.find(i=>i.uid===e);if(!n)return"<p>找不到此牌</p>";const s=H(n.defId);return`<h3>${s.name}</h3>
    <p>${te(s.suit)} ${we(s.suit)} ${G(s.rank)}　·　${Te(s)}</p>
    <p>${Pe[s.kind]??"暫無說明。"}</p>`}async function L(){var a;const e=t.game;if(!(!e||t.aiBusy||t.matchPaused)&&e.matchPhase!=="pick_general"){if(e.fx.play||e.fx.damages.length){t.aiBusy=!0,m();const n=Math.min(Math.max(t.settings.thinkDelayMs,500),1e3);if(await new Promise(s=>setTimeout(s,n)),t.matchPaused){t.aiBusy=!1,m();return}ve(e)&&!e.winnerIds&&oe(e),t.aiBusy=!1,m()}if(e.winnerIds){ke(),m();return}if(!t.matchPaused){t.aiBusy=!0,m();try{if(V()&&!t.lobbyVm.isHost)return;await ae(e,()=>{var n;t.screen==="table"&&t.game===e&&m(),V()&&t.lobbyVm.isHost&&t.game&&((n=t.mpClient)==null||n.send({type:"host_match",match:t.game}))},()=>t.matchPaused)}finally{t.aiBusy=!1}if(V()&&t.lobbyVm.isHost&&t.game&&((a=t.mpClient)==null||a.send({type:"host_match",match:t.game})),t.matchPaused){m();return}ve(e)&&!e.winnerIds&&oe(e),ke(),m()}}}function ve(e){const a=e.prompt.kind;return a==="choose_card"||a==="discard"||a==="game_over"||a==="idle"||a==="choose_general"}function vn(){const e=u().querySelector(".log");if(!e)return;const a=e.querySelector(".log-latest");a&&a.scrollIntoView({block:"nearest",behavior:"instant"}),e.scrollTop=e.scrollHeight}function kn(){var n,s,i,r,l,o,d,g,b;const e=t.game,a=ie(e);(n=u().querySelector("#coach-next"))==null||n.addEventListener("click",()=>{const y=Ce(e.config.campaignStageId);t.coachSlide+1>=y.length?t.coachSlide=-1:t.coachSlide+=1,m()}),(s=u().querySelector("#coach-skip"))==null||s.addEventListener("click",()=>{t.coachSlide=-1,m()}),u().querySelectorAll("[data-choice]").forEach(y=>{y.addEventListener("click",()=>{if(t.aiBusy||e.prompt.kind!=="choice"&&e.prompt.kind!=="skill_cards"||e.prompt.actorId!==a.id)return;const h=y.dataset.choice;_(e,{type:"choice",choiceId:h}),L()})}),u().querySelectorAll("[data-skill]").forEach(y=>{y.addEventListener("click",()=>{if(t.aiBusy||e.prompt.kind!=="choose_card"||e.prompt.actorId!==a.id)return;const h=y.dataset.skill;_(e,{type:"skill",skillId:h}),t.selectedUid=null,L()})}),u().querySelectorAll("[data-gen-info]").forEach(y=>{y.addEventListener("click",()=>{const h=y.dataset.genInfo;t.detailHtml=fn(h),m()})}),u().querySelectorAll("[data-pick-gen]").forEach(y=>{y.addEventListener("click",()=>{const h=y.dataset.pickGen;_(e,{type:"pick_general",generalId:h}),t.detailHtml=null,m(),L()})}),u().querySelectorAll("[data-info-seat]").forEach(y=>{y.addEventListener("click",h=>{h.stopPropagation(),h.preventDefault();const c=Number(y.dataset.infoSeat);t.detailHtml=bn(e.players[c]),m()})}),u().querySelectorAll("[data-info-card]").forEach(y=>{y.addEventListener("click",h=>{h.stopPropagation(),h.preventDefault();const c=y.dataset.infoCard;t.detailHtml=gn(c,a),m()})}),u().querySelectorAll(".card.selectable").forEach(y=>{y.addEventListener("click",()=>{if(t.aiBusy||e.matchPhase==="pick_general")return;const h=y.dataset.uid;if(e.prompt.kind==="choose_card"){if(t.selectedUid!==h){t.selectedUid=h,m();return}_(e,{type:"select_card",uid:h}),t.selectedUid=null,L();return}if(e.prompt.kind==="skill_cards"){_(e,{type:"select_card",uid:h}),m();return}_(e,{type:"select_card",uid:h}),t.selectedUid=null,L()})}),(i=u().querySelector("#cancel-select"))==null||i.addEventListener("click",()=>{t.selectedUid=null,m()}),u().querySelectorAll(".seat.targetable").forEach(y=>{y.addEventListener("click",()=>{if(t.aiBusy||e.matchPhase==="pick_general")return;const h=Number(y.dataset.seat);_(e,{type:"select_target",seatId:h}),L()})}),(r=u().querySelector("#end-play"))==null||r.addEventListener("click",()=>{t.aiBusy||(_(e,{type:"end_play"}),L())}),(l=u().querySelector("#pass-resp"))==null||l.addEventListener("click",()=>{t.aiBusy||(_(e,{type:"pass_response"}),L())}),(o=u().querySelector("#cancel-tgt"))==null||o.addEventListener("click",()=>{_(e,{type:"cancel_target"}),m()}),(d=u().querySelector("#ack-match-end"))==null||d.addEventListener("click",()=>{t.matchEndPending=!1,t.screen=t.stage?"epilogue":"result",m()}),(g=u().querySelector("#pause-match"))==null||g.addEventListener("click",()=>{if(t.matchPaused){t.matchPaused=!1,m(),L();return}t.matchPaused=!0,m()}),(b=u().querySelector("#flee"))==null||b.addEventListener("click",()=>{window.confirm("確定要退出對局嗎？進度不會保存。")&&(t.game=null,t.aiBusy=!1,t.matchEndPending=!1,t.matchPaused=!1,t.screen=t.stage?"story":"start",m())})}function ke(){const e=t.game;if(!(e!=null&&e.winnerIds)){t.matchEndPending=!1;return}if(!t.matchEndPending){const a=e.winnerIds.includes(0);if(mt({won:a,identity:e.config.mode==="identity5"||e.config.mode==="identity8"}),e.config.campaignStageId&&a){const n=qe(e.config.campaignStageId);if(n){De(n.campaign.id,n.stage.index),yt();const s=[];if(Ge(n.campaign.id)&&n.stage.index>=n.campaign.stages.length){const i=n.campaign.id.slice(3),r=P(i);ht(i,Le)&&s.push({kind:"skin",title:"解鎖 Q 版造型",detail:`${r.name}・簡單 Q 版角色樣`,generalId:i})}O(n.campaign.id)&&n.stage.index>=n.campaign.stages.length&&bt(),s.push(...ue()),t.unlockBanners=s}}else a&&(t.unlockBanners=ue());t.matchEndPending=!0}}function $n(){var l;const e=t.stage,a=t.game,n=!!((l=a.winnerIds)!=null&&l.includes(0)),s=Be(e,a),i=f(s).split(/\n+/).filter(Boolean).map(o=>`<p>${o}</p>`).join(""),r=$e({title:e.title,era:e.era,battlefieldCityId:e.battlefieldCityId,cityFactions:e.cityFactions,movements:e.movements,visibleCityIds:e.visibleCityIds});return`
  ...
  </div>`}function qn(){var e,a,n;(e=u().querySelector("#home"))==null||e.addEventListener("click",()=>{t.game=null,t.stage=null,t.unlockBanners=[],t.screen="start",m()}),(a=u().querySelector("#story"))==null||a.addEventListener("click",()=>{t.game=null,t.unlockBanners=[],t.screen="story",m()}),(n=u().querySelector("#again"))==null||n.addEventListener("click",()=>{if(t.unlockBanners=[],t.stage){t.screen="stage",m();return}t.screen="setup",m()})}function f(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}export{Cn as s};
