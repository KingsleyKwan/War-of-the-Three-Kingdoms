...
export const CARD_HELP: Record<string, string> = {
  ...
  wuzhong: '【無中生有】摸兩張牌。',
  guohe: '【過河拆橋】棄置目標區域內你選擇的一張牌。手牌背面朝上不可看內容；裝備與判定區可見。',
  shunshou: '【順手牽羊】獲得目標區域內你選擇的一張牌。手牌背面朝上不可看內容；裝備與判定區可見。',
  jiedao:
    '【借刀殺人】令一名裝備武器的角色對其攻擊範圍內另一名角色出【殺】；若其不出殺，則將武器交給你。',
  ...
  bingliang: '【兵糧寸斷】延時錦囊。置入目標判定區；其判定階段判定，非梅花則跳過摸牌階段。',
  lebu: '【樂不思蜀】延時錦囊。置入目標判定區；其判定階段判定，非紅桃則跳過出牌階段。',
